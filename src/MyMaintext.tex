...
The project was started by Paulus Schoutsen in 2013 with the initial aim to take greater control of the Philips Hue devices that he had purchased at that time. Over the course of the coming years and with the help of mainly volunteer contributors, Home Assistant grew to become one of the leading smart home platforms \cite{OpenHomeFoundation_About} and most widely used home automation system for DIY enthusiasts.
...
\begin{table}[H]
    ...
    \begin{tabularx}{\textwidth}{| l | p{0.5\linewidth} | *{5}{>{\small\centering\arraybackslash}X|}}
        ...
        \multirow{17}{*}{\rotatebox[origin=c]{90}{Active Tools}} & \multicolumn{6}{l |}{\rule{0pt}{3.5ex}\textbf{Control Options}} \\ \cline{2-7}
        ...
        \multirow{12}{*}{\rotatebox[origin=c]{90}{Passive Tools}} & \multicolumn{6}{l |}{\rule{0pt}{3.5ex}\textbf{Automations}} \\ \cline{2-7}
        ...
        & Simple Conditional Logic & \ding{51} & \ding{51} & \ding{51} & & \ding{51} \\ \cline{3-7}
        & Follow-up actions & & & & & \ding{51} \\ \cdashline{2-7}
        & \textbf{A-Score} & 4 & 4 & 4 & 2 & 5 \\ \cline{2-7}
        & \multicolumn{6}{l |}{\rule{0pt}{3.5ex}\textbf{Voice Assistants}} \\ \cline{2-7}
        & Obtain external information & \ding{51} & \ding{51} & & \ding{51} & \\ \cline{3-7}
        & Perform actions & \ding{51} & \ding{51} & & \ding{51} & \ding{51} \\ \cline{3-7}
        & Set a reminder & \ding{51} & \ding{51} & & \ding{51} & \ding{51} \\ \cline{3-7}
        & Set a timer & \ding{51} & \ding{51} & & \ding{51} & \ding{51} \\ \cline{3-7}
        & Identify voice of household members & \ding{51} & \ding{51} & & \ding{51} & \\ \cdashline{2-7}
        & \textbf{V-Score} & 5 & 5 & & 5 & 3 \\ \hline
        \multicolumn{2}{r |}{\textbf{Total score}} & 17 & 18 & 18 & 18 & 23 \\ \cline{3-7}
    \end{tabularx}
\end{table}
